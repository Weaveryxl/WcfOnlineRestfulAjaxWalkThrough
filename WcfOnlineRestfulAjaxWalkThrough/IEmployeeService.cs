...
namespace WcfOnlineRestfulAjaxWalkThrough
{
   [ServiceContract]
    ...
    { 
        ...
        [OperationContract]
        [WebInvoke(Method = "GET", UriTemplate = "/GetEmployeeDetails/{EmpId}", RequestFormat = WebMessageFormat.Json,ResponseFormat = WebMessageFormat.Json)]
        ...
        [OperationContract]
        [WebInvoke(Method = "POST", UriTemplate = "/TestEmployeeAdd/", BodyStyle = WebMessageBodyStyle.Wrapped, RequestFormat = WebMessageFormat.Json,ResponseFormat = WebMessageFormat.Json)]
